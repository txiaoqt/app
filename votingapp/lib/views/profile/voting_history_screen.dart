      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            const Center(
              child: Text('Voting History', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
            ),
            const SizedBox(height: 18),
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 24.0),
              child: Text('Recent Votes', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
            ),
              ...
              child: InkWell(
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => const VotingHistoryDetailScreen()),
                  );
                },
                child: Container(
